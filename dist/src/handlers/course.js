...
exports.getCourseById = exports.createCourse = exports.getCoures = void 0;
...
var getCoures = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1["default"].course.findMany()];
            case 1:
                courses = _a.sent();
...
var getCourseById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1["default"].course.findUnique({ where: { id: +req.params.id } })];
            case 1:
                course = _a.sent();
                if (!course) {
